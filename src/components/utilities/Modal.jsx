  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog as='div' className='relative z-50' onClose={closeModal}>
                ...
                <div className='relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full'>
                  <div className='bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
                    <div className='sm:flex sm:items-start'>
                      <div
                        className={`mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-${content.color}-100 sm:mx-0 sm:h-10 sm:w-10`}>
                        {content.icon ? (
                          content.icon
                        ) : (
                          <svg
                            className={`h-6 w-6 text-${content.color}-600`}
                  ...
                  <div className='bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse'>
                    <button
                      type='button'
                      className={`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-${content.color}-600 text-base font-medium text-white hover:bg-${content.color}-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-${content.color}-500 sm:ml-3 sm:w-auto sm:text-sm`}>
                      {content.action}
                    </button>
                    <button
                      type='button'
        ...
        {/* <div className='fixed inset-0 overflow-y-auto opacity-25 bg-black'>
          <div className='flex min-h-full items-center justify-center p-4 text-center'>
            <Transition.Child
              as={Fragment}
              enter='ease-out duration-300'
