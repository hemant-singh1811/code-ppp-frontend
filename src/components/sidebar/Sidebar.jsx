...
import { handelAddSideBar, handelToggleSideBar } from "../../store/features/SideBarStateSlice";
...
export default function Sidebar() {
  ...
  useEffect(() => {
    if (data) {
      ...
      createMenusByBase = data?.map((item) => {
        return {
  ...
  return (
    ...
    >
      ...
      <ul className="">
        {Array.isArray(sidebar) && sidebar.map((item, i) => {
          return (
            item?.title && (
