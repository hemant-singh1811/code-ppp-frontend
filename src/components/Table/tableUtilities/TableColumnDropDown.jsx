...
export default function TableColumnDropDown({ columnDropdownRef, columnDef, open, close, isMenuOpen, setIsMenuOpen }) {
  ...
  return (
    <>
      <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="border-none outline-none h-full mr-2">
