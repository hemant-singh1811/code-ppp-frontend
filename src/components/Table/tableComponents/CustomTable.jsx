    ...
    <Popover className="" ref={buttonRef}>
      {({ open, close }) => (
        <div
          ...
          className={`th  bg-[#f5f5f5] relative ${index === 0 && "fixed-column "} relative`}
          {...{
            key: header.id,
            style: {
        ...
        >
          ...
          >
            <div className="flex items-center w-[calc(100%_-_20px)]">
              <div className=" h-full min-w-[20px]" onMouseEnter={() => handleMouseOver(column.columnDef.field_type)} onMouseLeave={() => handleMouseLeave(column.columnDef.field_type)} >
            ...
            <div ref={divRef} className="absolute top-9 bg-white rounded-md px-2 border-2 hidden min-w-max">
              {fieldName(column.columnDef.field_type)}
            </div>

            <TableColumnDropDown
              open={open} close={close} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen}
